...
describe('7 - Implemente o header de acordo com a necessidade de cada tela', () => {
  ...
  it('Rota "/meals/{id}": não possui header', () => {
    cy.visit('http://localhost:3000/meals/52771');

    hasNoHeader();
  });

  it('Rota "drinks/{id}": não possui header', () => {
    cy.visit('http://localhost:3000/drinks/178319');

    hasNoHeader();
  });

  it('Rota "/meals/{id}/in-progress": não possui header', () => {
    cy.visit('http://localhost:3000/meals/52771/in-progress');

    hasNoHeader();
  });

  it('Rota "/drinks/{id}/in-progress": não possui header', () => {
