import { removeCartID, productPrice } from './cartFunctions';
...
const removeCartProduct = (li, id) => {
  const price = li.getElementsByClassName('product__price__value')[0].innerHTML;
  productPrice(parseFloat(price), 'sub');
  li.remove();
  removeCartID(id);
};
